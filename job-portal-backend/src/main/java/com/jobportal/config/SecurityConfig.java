    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/jobs/employer/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/jobs/recommended/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/companies/user/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/ws/**", "/ws-stomp/**", "/notifications/**", "/presence/**").permitAll()
