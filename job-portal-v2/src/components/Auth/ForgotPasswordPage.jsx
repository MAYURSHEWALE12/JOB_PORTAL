                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input 
                                            ...
                                            placeholder="000000"
                                            className="hp-input pl-12 h-14 text-center text-2xl font-black tracking-[0.2em] bg-[rgba(var(--hp-surface-alt-rgb),0.5)] border-[rgba(255,255,255,0.05)] focus:bg-[var(--hp-surface-alt)]"
                                            required
                                        />
                                    </div>
                                </div>
